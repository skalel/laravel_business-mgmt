      ...
      <div class="overflow-hidden bg-gray-200 shadow-sm dark:bg-gray-800 sm:rounded-lg">
        <div class="rounded-lg py-8 shadow-md">
          <div class="card-body p-4 text-gray-800 dark:text-gray-200">
            <h2 class="mb-4 text-2xl font-bold">Detalhes do produto #{{ $stock->id }} - {{ $stock->prod_name }}</h2>
            <form method="GET" action="{{ route('stock.edit', ['id' => $stock->id]) }}"
              ...
              <div class="flex flex-wrap">
                <div class="flex-grow flex-col pr-2">
                  ...
                  <input type="text" name="id_finances" id="id_finances" value="{{ $stock->id }}"
                    class="mb-4 w-full cursor-not-allowed rounded-md border p-2 text-gray-900" disabled>
                </div>
              ...
              <div class="flex flex-wrap">
                <div class="flex-grow flex-col pr-2">
                  ...
                  <input type="number" id="prod_width" name="prod_width" value="{{ $stock->prod_width }}"
                    class="no-spinner mb-4 w-full cursor-not-allowed rounded-md border p-2 text-gray-900" disabled>
                </div>
              ...
              <div class="flex justify-end gap-2">
                <button type="submit" class="rounded-md bg-blue-500 p-2 text-white hover:bg-blue-700">Editar</button>
